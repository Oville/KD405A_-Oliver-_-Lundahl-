...
public class TestClass {
	...
	public static void main(String[] args) {
		// Koden söker på förinställda stationer och nummern de har tilldetllats. 
		//Koden skriver sedan ut resultaten av linjer som passerar och ger som innställt 20 resultat
		...
		//koden söker igenom urlen efter resor.
	   ...
	   System.out.println("// Stations when searching for stations containing \"Malm\"");
		//skapar en arraylist med stationer som innehåller Malm
	   ArrayList<Station> searchStations = new ArrayList<Station>(); 
	   //Koden letar igenom stationerna och lägger till de som har med Malm att göra.
