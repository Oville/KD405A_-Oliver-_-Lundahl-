...
public class TryIt extends JFrame {
	...
	public TryIt() {
		...
		px.setPixel(100, 11, Color.GREEN);
		px.setPixel(100, 12, Color.RED);
		px.setPixel(100, 13, Color.YELLOW);
		px.setPixel(101, 10, Color.RED);
		px.setPixel(101, 11, Color.GREEN);
		px.setPixel(101, 12, Color.RED);
		px.setPixel(101, 13, Color.YELLOW);
